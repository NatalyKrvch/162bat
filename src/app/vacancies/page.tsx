...
const VacanciesPage = () => {
  ...
  return (
    <Container className="pb-12 lg:pb-20">
      <div className="flex flex-col items-start pt-10 pb-10 lg:mb-10 lg:flex-row lg:items-center lg:justify-between lg:pt-20 lg:pb-10 xl:mb-10">
        <SectionTitle className="xl:text-14 w-fit text-left text-4xl leading-[120%] tracking-normal lg:text-5xl lg:leading-[110%]">
          {title}
        </SectionTitle>
      </div>
